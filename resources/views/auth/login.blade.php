...
<body class="auth-background min-h-screen flex items-center justify-center font-sans relative">
    <div class="glass-effect p-10 rounded-2xl shadow-2xl w-full max-w-md relative z-10">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-brown mb-2">Welcome Back!</h1>
            <p class="text-sm text-gray-600">Sign in to your coffee lover's account</p>
        </div>
        ...
        <div class="text-center mt-6">
            <p class="text-sm text-gray-600">
                ...
                <a href="{{ route('register') }}" class="text-brown font-semibold hover:text-brown-dark transition-colors duration-200">Create one now</a>
            </p>
        </div>
    </div>
</body>
